...
manual `_verify_integrity` check in [Verify the repository](#verify-the-repository-after-any-deletion-traffic-not-just-after-the-migration).
...
Validation: 363 unit tests (`python3 -m unittest discover -s tests`), two
